...
var d = B.damage
   if(buls.length>0 && buls[PLR.substr(1,1)]!=undefined && buls[PLR.substr(1,1)][0]==plr){
    buls[PLR.substr(1,1)][1].sprite.position.x=x
    buls[PLR.substr(1,1)][1].sprite.position.y=y
    buls[PLR.substr(1,1)][1].sprite.velocityX=vx
    buls[PLR.substr(1,1)][1].sprite.velocityY=vy
    buls[PLR.substr(1,1)][1].d=d
   }
  else if(buls.length==0 || (buls[PLR.substr(1,1)]==undefined)){
