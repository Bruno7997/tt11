...
for (var i=0;i<m.length;i++){
  if(player.index!=null&&p.length>0){
    console.log((player.index-1)+" "+m[i].indexXY)
  ...
  dy[0]=dy[indexY]
    ...
    if(m[i].sprite.collide(p[player.index-1])&&player.index!=null){m[i].indexXY=0;retirarJ(player.index-1);console.log("A")}
    else if(m[i].sprite.collide(p[m[i].indexXY])){retirarJ(m[i].indexXY);m[i].indexXY=0;console.log("B")}
    if(m.length>0){
...
if(m.length==0&&keyCode==32&&gameState==1){;qdm+=(qdm/(Round*0.95));game.update(0)}
  ...
  //W:
if(keyCode===87&&X!=1){setTimeout(()=>{if(player.index!=null){var bul = new Bullet(p[player.index-1].position.x,p[player.index-1].position.y,0,-vdb,d,player.index,1);buls.push([player.index-1,bul])}},500);bul.update()}
  //S:
if(keyCode===83&&X!=1){setTimeout(()=>{if(player.index!=null){var bul = new Bullet(p[player.index-1].position.x,p[player.index-1].position.y,0,vdb,d,player.index,1);buls.push([player.index-1,bul])}},500);bul.update()}
  //A:
if(keyCode===65&&X!=1){setTimeout(()=>{if(player.index!=null){var bul = new Bullet(p[player.index-1].position.x,p[player.index-1].position.y,-vdb,0,d,player.index,1);buls.push([player.index-1,bul])}},500);bul.update()}
  //D:
if(keyCode===68&&X!=1){setTimeout(()=>{if(player.index!=null){var bul = new Bullet(p[player.index-1].position.x,p[player.index-1].position.y,vdb,0,d,player.index,1);buls.push([player.index-1,bul])}},500);bul.update()}

//Contrario do Relogio
//W:
if(keyCode===87&&X==1){setTimeout(()=>{if(player.index!=null){var bul = new Bullet(p[player.index-1].position.x,p[player.index-1].position.y,-vdb,-vdb,d,player.index,1);buls.push([player.index-1,bul])}},500);bul.update()}
  //S:
if(keyCode===83&&X==1){setTimeout(()=>{if(player.index!=null){var bul = new Bullet(p[player.index-1].position.x,p[player.index-1].position.y,vdb,vdb,d,player.index,1);buls.push([player.index-1,bul])}},500);bul.update()}
  //A:
if(keyCode===65&&X==1){setTimeout(()=>{if(player.index!=null){var bul = new Bullet(p[player.index-1].position.x,p[player.index-1].position.y,-vdb,vdb,d,player.index,1);buls.push([player.index-1,bul])}},500);bul.update()}
  //D:
if(keyCode===68&&X==1){setTimeout(()=>{if(player.index!=null){var bul = new Bullet(p[player.index-1].position.x,p[player.index-1].position.y,vdb,-vdb,d,player.index,1);buls.push([player.index-1,bul])}},500);bul.update()}
}
